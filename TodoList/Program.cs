...
namespace TodoList
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            do {
                ...
                switch (opcao) 
                {
                    ...
                    case 3:
                    System.Console.WriteLine("Vá, e não volte");
                    SaveItem(todoList,filePath);
                    break;

                    default:
                        System.Console.WriteLine("Opcao grandao");
                        Console.ReadLine();
                    break;
        ...
        public static void ListaItens(List<TodoItem> todoList)
        {
            Console.Clear();
            int count = 1;
            System.Console.WriteLine("Lista de Afazeres");
            System.Console.WriteLine();
        ...
        private static void SaveItem(List<TodoItem> lista, string filePath)
        {
            ...
            do
            {
                ...
                {
                    System.Console.WriteLine("Error 404 = Erro na gravação do arquivo!");
